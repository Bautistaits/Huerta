import { initializeApp } from "https://www.gstatic.com/firebasejs/12.4.0/firebase-app.js"; 
    ...
    onValue(refHuerta, (snapshot) => {
      ...
      if (huerta) {
        parrafo.innerHTML = `
          <div class="dato">🌡️ Temperatura: ${huerta.temperatura}°C</div>
          <div class="dato">💨 Humedad del Aire: ${huerta.humedadAire}%</div>
          <div class="dato">💧 Humedad del Suelo: ${huerta.humedadSuelo}%</div>
        `;

        // Determinar qué imagen/emoji mostrar
        if (huerta.temperatura > 35) {
          imagen.innerHTML = "🔥";
